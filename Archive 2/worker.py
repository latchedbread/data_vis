...
class Worker:
    ...
    def run(self) -> Dict[str, Any]:
        ...
        try:
            ...
            scraped_df, scraping_warning = scraper.scrape(self._job.start_date, self._job.end_date)
            ...
            store_warning = server.save_to_table(scraped_df)

            #executing the query
            client = DataBaseClient(self._job.ticker, self._job.db_path)
            prices, query_warning = client.query_prices()
